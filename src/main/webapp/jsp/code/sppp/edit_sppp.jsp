...
<html>
	...
	<body style="background:linear-gradient(white,#ebebeb,white);">
		<label class="control-label label-default col-xs-12 " style="margin-bottom: 30px;">
			<h4>当前位置：商品品牌 － 修改商品品牌</h4>
		</label>
		<div class="container">
			<hr>
			<form class="form-horizontal text-center" name="infoForm" action="javascript:doSub()" method="post">
				<input type="hidden" name="cspId" value="${sppp.cspId}">
				<div class="container ">
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">商品品牌名称:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="cspName" value="${sppp.cspName}" placeholder="请输入商品品牌名称" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">商品品牌编码:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="cspCode" value="${sppp.cspCode}" placeholder="请输入商品品牌编码" />
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function tijiao(){
		$("form[name='infoForm']").attr("action","<%=ctx%>/sppp/edit.action");
		$("form").submit();
	}
