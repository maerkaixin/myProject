...
<html>
	...
	<body style="background:linear-gradient(white,#ebebeb,white);">
		<label class="control-label label-default col-xs-12 " style="margin-bottom: 30px;">
			<h4>当前位置：信誉等级 － 修改信誉等级</h4>
		</label>
		<div class="container">
			<hr>
			<form class="form-horizontal text-center" name="infoForm" action="javascript:doSub()" method="post">
				<input type="hidden" name="cxyId" value="${xydj.cxyId}">
				<div class="container ">
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">信誉等级名称:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="cxyName" value="${xydj.cxyName}" placeholder="请输入信誉等级名称" />
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function tijiao(){
		$("form[name='infoForm']").attr("action","<%=ctx%>/xydj/edit.action");
		$("form").submit();
	}
