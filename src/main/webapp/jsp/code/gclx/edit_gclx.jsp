...
<html>
	...
	<body style="background:linear-gradient(white,#ebebeb,white);">
		<label class="control-label label-default col-xs-12 " style="margin-bottom: 30px;">
			<h4>当前位置：工程类型 － 修改工程类型</h4>
		</label>
		<div class="container">
			<hr>
			<form class="form-horizontal text-center" name="infoForm" action="javascript:doSub()" method="post">
				<input type="hidden" name="cglId" value="${gclx.cglId}">
				<div class="container ">
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">工程类型名称:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="cglName" value="${gclx.cglName}" placeholder="请输入工程类型名称" />
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function tijiao(){
		$("form[name='infoForm']").attr("action","<%=ctx%>/gclx/edit.action");
		$("form").submit();
	}
