				...
				<div class="container ">
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="cahName" placeholder="请输入爱好类型名称" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">爱好类型编码:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="cahCode" placeholder="请输入爱好类型编码" />
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function tijiao(){
		$("form[name='infoForm']").attr("action","<%=ctx%>/aihao/save.action");
		$("form").submit();
	}
