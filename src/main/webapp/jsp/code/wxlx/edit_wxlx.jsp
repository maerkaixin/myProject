...
<html>
	...
	<body style="background:linear-gradient(white,#ebebeb,white);">
		<label class="control-label label-default col-xs-12 " style="margin-bottom: 30px;">
			<h4>当前位置：维修类型 － 修改维修类型</h4>
		</label>
		<div class="container">
			<hr>
			<form class="form-horizontal text-center" name="infoForm" action="javascript:doSub()" method="post">
				<input type="hidden" name="cxyId" value="${wxlx.cwlId}">
				<div class="container ">
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">维修类型名称:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="cxyName" value="${wxlx.cwlName}" placeholder="请输入维修类型名称" />
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function tijiao(){
		$("form[name='infoForm']").attr("action","<%=ctx%>/wxlx/edit.action");
		$("form").submit();
	}
