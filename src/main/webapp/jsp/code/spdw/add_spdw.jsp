				...
				<div class="container ">
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="csdName" placeholder="请输入商品单位名称" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2 col-md-2">商品单位编码:</label>
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="csdName" placeholder="请输入商品单位编码" />
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function tijiao(){
		$("form[name='infoForm']").attr("action","<%=ctx%>/spdw/save.action");
		$("form").submit();
	}
