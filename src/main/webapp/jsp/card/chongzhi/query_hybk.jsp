...
<script type="text/javascript">
	...
	function xuanze(hcId,hyName,cardName,hcNo,hcNum){
		$(parent.document).find("#hyName").html(hyName);
		$(parent.document).find("#cardName").html(cardName);
		$(parent.document).find("#hcNo").html(hcNo);
		$(parent.document).find("#hcNum").html(hcNum);
		$(parent.document).find("#hcId").val(hcId);
		parent.closeModal();
	}
