				...
				<div class="container">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group text-left">
								...
								<label class="control-label" id="hyName">张飞</label>
							</div>
							<div class="form-group text-left">
								<label class="control-label col-sm-3">卡类型名称 : </label>
								<label class="control-label" id="cardName">美白亮夫卡</label>
							</div>
							<div class="form-group text-left">
								<label class="control-label col-sm-3">卡号 : </label>
								<label class="control-label" id="hcNo">620123456789010</label>
							</div>
							<div class="form-group text-left">
								<label class="control-label col-sm-3">余额 : </label>
								<label class="control-label" id="hcNum">100</label>
							</div>
						</div>
					</div>
					<hr/>
					<div class="form-group">
						...
						<div class="col-md-10 col-sm-10">
							<textarea class="form-control" name="tkInfo" rows="3" placeholder="填写退卡原因" retuired="true"></textarea>
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function tijiao(){
		$("form[name='infoForm']").attr("action","<%=ctx%>/tk/addsave.action");
		$("form").submit();
	}
